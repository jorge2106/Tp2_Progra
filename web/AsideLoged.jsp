...
<aside>
    <nav>
        ...
        <ul>
            ...
            <li><a href="userController.jsp?option=Eliminar"><h3>Eliminar Cuenta</h3></a></li>
            <li><a href="userController.jsp?option=Cerrar"><h3>Cerrar Sesión</h3></a></li>
            <a href="ShoopingCart.jsp"><img src="img/carrito-compra-1-crop-u21808.png" alt="carrito" style="width:100px;height:88px;"></a>
        </ul>
    </nav><br>
